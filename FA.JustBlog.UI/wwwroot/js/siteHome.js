$(document).ready(function () {
    var itemsPerPage = 3;
    var currentPage = 1;
    var totalPages = Math.ceil($('#imageGallery .post-preview').length / itemsPerPage);
    ...
    $('#imageGallery').on('click', '.galleryhome img', function () {
    ...
    function displayPage(page) {
        ...
        $('#imageGallery .post-preview').hide();
        $('#imageGallery .post-preview').slice(startIndex, endIndex + 1).show();
